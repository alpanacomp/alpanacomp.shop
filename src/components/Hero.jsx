...
function Hero() {
  return (
    <section className="relative text-gray-900 dark:text-white py-20 px-6 overflow-hidden" data-aos="fade-left">
      <div
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
        <div className="flex-1">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-6">
            ...
            we provide you reliable and budget-friendly desktop PCs tailored for your home, office, or gaming needs.
          </p>
          <Link
            to="/about"
