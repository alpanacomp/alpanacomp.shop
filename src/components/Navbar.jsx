  ...
  return (
    <nav className={`${navbarClasses} px-6 py-3 flex justify-between items-center`}>
      ...
      <div className="hidden md:flex items-center gap-6">
        ...
        <Link to="/contact" className="text-gray-700 dark:text-gray-200 hover:underline">
          Contact
        </Link>
      ...
      {menuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-white dark:bg-gray-900 shadow-md py-4 px-6 flex flex-col gap-4 z-40">
          ...
          <Link to="/contact" className="text-gray-700 dark:text-gray-200" onClick={() => setMenuOpen(false)}>
            Contact
          </Link>
          ...
          <label className="inline-flex items-center cursor-pointer">
            ...
            <div className="w-11 h-6 bg-gray-300 rounded-full peer dark:bg-gray-600 peer-checked:bg-blue-600 transition-colors duration-300 relative">
              <div className="absolute top-0.5 left-0.5 bg-white w-5 h-5 rounded-full transition-transform duration-300 peer-checked:translate-x-5" />
            </div>
          </label>
        </div>
      )}
